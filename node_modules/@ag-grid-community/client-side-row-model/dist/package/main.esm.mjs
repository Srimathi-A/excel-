...
import { BeanStub as BeanStub3, RowNode as RowNode3, _exists as _exists2, _missingOrEmpty as _missingOrEmpty3 } from "@ag-grid-community/core";
...
import { BeanStub as BeanStub4, _errorOnce as _errorOnce3, _exists as _exists3, _iterateObject, _missing as _missing2 } from "@ag-grid-community/core";
var ImmutableService = class extends BeanStub4 {
  ...
  createTransactionForRowData(rowData) {
    if (_missing2(this.clientSideRowModel)) {
...
import { BeanStub as BeanStub5, _errorOnce as _errorOnce4, _missing as _missing3, _warnOnce as _warnOnce3 } from "@ag-grid-community/core";
var SortService = class extends BeanStub5 {
  ...
  updateChildIndexes(rowNode) {
    if (_missing3(rowNode.childrenAfterSort)) {
      return;
    }
  ...
  pullDownGroupDataForHideOpenParents(rowNodes, clearOperation) {
    if (!this.gos.get("groupHideOpenParents") || _missing3(rowNodes)) {
      return;
    }
...
import { BeanStub as BeanStub6, _exists as _exists4 } from "@ag-grid-community/core";
