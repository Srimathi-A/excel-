...
var import_core22 = require("@ag-grid-enterprise/core");
...
// enterprise-modules/row-grouping/src/rowGrouping/groupStage/groupStrategy.ts
...
var TreeStrategy = class extends import_core16.BeanStub {
  ...
  handleTransaction(details) {
    ...
    if (details.rowNodeOrder) {
      details.changedPath.forEachChangedNodeDepthFirst(
        (node) => {
          const didSort = (0, import_core16._sortRowNodesByOrder)(node.childrenAfterGroup, details.rowNodeOrder);
          if (didSort) {
            details.changedPath.addParentNode(node);
          }
        },
  ...
  removeFromParent(child, batchRemover) {
    if (child.parent) {
      if (batchRemover) {
        ...
        (0, import_core16._removeFromArray)(child.parent.childrenAfterGroup, child);
        child.parent.updateHasChildren();
      }
    }
  ...
  createGroup(key, parent, level, details) {
    const groupNode = new import_core16.RowNode(this.beans);
    groupNode.group = true;
    ...
    groupNode.key = key;
    groupNode.id = import_core16.RowNode.ID_PREFIX_ROW_GROUP + this.createGroupIdEnd(groupNode, parent, level);
    groupNode.level = level;
  ...
  getDataPath({ data }, { getDataPath }) {
    ...
    if (!keys.length) {
      (0, import_core16._warnOnce)(`getDataPath() should not return an empty path for data ${data}`);
    }
    return keys;
  }
};
...
// enterprise-modules/row-grouping/src/rowGrouping/groupStage/groupStage.ts
var GroupStage = class extends import_core17.BeanStub {
  constructor() {
    super(...arguments);
...
var PivotColDefService = class extends import_core18.BeanStub {
  constructor() {
    super(...arguments);
  ...
  createPivotColumnDefs(uniqueValues) {
    ...
    const pivotColumnDefsClone = pivotColumnDefs.map((colDef) => (0, import_core18._cloneObject)(colDef));
    return {
  ...
  recursivelyBuildGroup(index, uniqueValue, pivotKeys, maxDepth, primaryPivotColumns) {
    ...
    if (measureColumns.length === 1 && this.gos.get("removePivotHeaderRowWhenSingleValueColumn") && index === maxDepth - 1) {
      const leafCols = [];
      (0, import_core18._iterateObject)(uniqueValue, (key) => {
    ...
    const groups = [];
    (0, import_core18._iterateObject)(uniqueValue, (key, value) => {
...
var PivotStage = class extends import_core19.BeanStub {
  constructor() {
    super(...arguments);
  ...
  bucketChildren(children, pivotColumns, pivotIndex, uniqueValues) {
    ...
    children.forEach((child) => {
      ...
      if ((0, import_core19._missing)(key)) {
        key = "";
      }
      if (!uniqueValues[key]) {
    ...
    if (pivotIndex === pivotColumns.length - 1) {
      ...
      const result = {};
      (0, import_core19._iterateObject)(mappedChildren, (key, value) => {
...
var ShowRowGroupColsService = class extends import_core20.BeanStub {
  constructor() {
    super(...arguments);
...
// enterprise-modules/row-grouping/src/rowGroupingModule.ts
var RowGroupingCoreModule = (0, import_core21._defineModule)({
  version: VERSION,
  moduleName: `${import_core21.ModuleNames.RowGroupingModule}-core`,
  beans: [
    AggregationStage,
  ...
  userComponents: [
    {
      ...
      classImp: import_core22.GroupCellRenderer
    },
    {
  ...
  controllers: [{ name: "groupCellRendererCtrl", classImp: import_core22.GroupCellRendererCtrl }],
  dependantModules: [import_core22.EnterpriseCoreModule]
});
var RowGroupingApiModule = (0, import_core21._defineModule)({
  version: VERSION,
  moduleName: `${import_core21.ModuleNames.RowGroupingModule}-api`,
  apiFunctions: {
    addAggFunc,
    addAggFuncs,
    clearAggFuncs,
...
var GroupFilterModule = (0, import_core21._defineModule)({
  version: VERSION,
  moduleName: "@ag-grid-enterprise/group-filter",
  userComponents: [{ name: "agGroupColumnFilter", classImp: GroupFilter }],
  dependantModules: [RowGroupingCoreModule, import_core21._ColumnFilterModule]
});
var GroupFloatingFilterModule = (0, import_core21._defineModule)({
  version: VERSION,
  ...
  dependantModules: [GroupFilterModule, import_core21._FloatingFilterModule]
});
var RowGroupingModule = (0, import_core21._defineModule)({
  version: VERSION,
  moduleName: import_core21.ModuleNames.RowGroupingModule,
...
var ValuesDropZonePanel = class extends BaseDropZonePanel {
  ...
  postConstruct() {
    ...
    super.init({
      icon: (0, import_core23._createIconNoSpan)("valuePanel", this.gos, null),
      emptyMessage,
      title
    });
